...
🏆 **제21회 한성공학경진대회 금상 수상작** (16번 팀)

EMS(전기근육자극) 기반 뇌졸중·마비 환자 재활 보조 시스템 — 한성공학경진대회 16번 팀.

> 팀 프로젝트 저장소를 바탕으로 개인 포트폴리오용으로 정리한 저장소입니다.
> 코드/문서는 팀원들과 함께 작업했으며, 그중 대부분은 제가 직접 작성했습니다.

## 팀 및 역할

- **팀장 (홍서준)** — 전체 기획, 시스템 설계, 웹앱/펌웨어 코드 작성, 하드웨어 트러블슈팅 및 팀 일정 관리 총괄
- 팀원들과 함께 하드웨어 제작(납땜/PCB), 발표 자료, 대회 제출 문서를 분담 작업

개발 과정에서 겪은 문제와 해결 과정(자기소개서용 요약)은
[`docs/자기소개서용_문제해결사례.md`](docs/자기소개서용_문제해결사례.md)에,
전체 개발 히스토리는 [`docs/프로젝트_진행_타임라인.md`](docs/프로젝트_진행_타임라인.md)에 정리되어 있습니다.
...
| `docs/` | 대회 제출용 보고서·전시 판넬(A2)·발표자료·전시용 사진·설계 정리 문서·시연 대본과 Q&A·시연 시 패치 위치 사진·개발 커밋 히스토리 원문·팀 대화 기반 프로젝트 진행 타임라인·문제 해결 과정 정리(`자기소개서용_문제해결사례.md`). |
